...
public class ConnexionCameneonClient {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        try {
            ...
            BufferedReader ir = getLecture(socket);
            PrintWriter envoyer = getEcriture(socket);
            ...
            Thread lireSockStdOut = new Thread(new GererArriverCameneon(ir, envoyer, ".", couleurCameneonCourant));
